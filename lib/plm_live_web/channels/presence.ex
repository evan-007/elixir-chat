defmodule PLMLiveWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule PLMLive.MyChannel do
        use PLMLiveWeb, :channel
        alias PLMLive.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :plm_live,
                        pubsub_server: PLMLive.PubSub
end
